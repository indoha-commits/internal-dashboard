    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="page-desc mt-2">
          Cargos awaiting document upload and assessment review
        </p>
      </div>
      ...
      <div className="hidden md:grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-card rounded-lg p-5 border border-default">
          ...
          <div className="text-3xl kpi-value">{summary.pendingUpload}</div>
        </div>
        <div className="bg-card rounded-lg p-5 border border-default">
          <div className="flex items-center gap-3 mb-2">
          ...
          <div className="text-3xl kpi-value">{summary.pendingValidation}</div>
        </div>
        <div className="bg-card rounded-lg p-5 border border-default">
          <div className="flex items-center gap-3 mb-2">
      ...
      <div className="block md:hidden grid grid-cols-3 gap-3 mb-6">
        <div className="bg-card rounded-lg p-3 border border-default text-center">
          <div
          ...
          <div className="text-xl font-bold">{summary.pendingUpload}</div>
        </div>
        <div className="bg-card rounded-lg p-3 border border-default text-center">
          <div
            className="text-xs font-medium mb-0.5"
          ...
          <div className="text-xl font-bold">{summary.pendingValidation}</div>
        </div>
        <div className="bg-card rounded-lg p-3 border border-default text-center">
          <div
            className="text-xs font-medium mb-0.5"
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p className="empty-sub">
              Items appear here when documents need validation
            </p>
          </div>
        ) : (
                  ...
                  {expanded && (
                    <div className="mt-4 space-y-3">
                      {g.items.map((it) => {
                        ...
                        const cargoExpanded =
                          expandedCargo[it.cargo_id] ?? false;

                        const canUploadRequired =
                          it.validation_status === "pending_upload" ||
                          it.validation_status === "pending_validation" ||
                          it.validation_status === "failed";
                        const canUploadOptional =
                          canUploadRequired ||
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      <div className="rounded-lg p-4 bg-muted">
                                        <div className="flex items-start justify-between gap-4">
                                          ...
                                          <div className="flex items-center gap-2 shrink-0 flex-wrap justify-end">
                                            {it.assessment &&
                                              (it.assessment.file_path ||
                                                it.assessment.file_url) && (
                                                <Button
                                                  variant="outline"
                                                  onClick={async () => {
                                                    try {
                                                      const { url } =
                                                        await getOpsApprovalSignedUrl(
                                                          it.assessment!.id,
                                                        );
                                                      window.open(
                                                        url,
                                        ...
                                        {it.assessment?.status === "REJECTED" &&
                                          it.assessment?.rejection_reason && (
                                            <div
                                              className="flex items-start gap-2 mt-3 px-3 py-2 rounded text-xs"
                                              style={{
                                                backgroundColor:
                                                  "rgba(239, 68, 68, 0.1)",
                                                borderLeft:
                                      ...
                                      <div className="rounded-lg p-4 bg-muted">
                                        <div className="flex items-start justify-between gap-4">
                                          ...
                                          <div className="flex items-center gap-2 shrink-0 flex-wrap justify-end">
                                            {it.exit_note &&
                                              (it.exit_note.file_path ||
                                                it.exit_note.file_url) && (
                                                <Button
                                                  variant="outline"
                                                  onClick={async () => {
                                                    try {
